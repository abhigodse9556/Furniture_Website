...
async function seed() {
  const { getDb } = await import("../src/server/config/firebaseAdmin");
  const db = getDb();
  ...
  const banners = [
    "/images/banners/banner-1.jpeg",
    "/images/banners/banner-2.jpeg",
  ];
  ...
  const seedProducts: Array<{
    ...
    },
    {
      ...
      category: "chairs",
      description:
        "Weather-ready wooden seating with clean lines — suited for verandahs, gardens, and open courtyards.",
      imageUrl:
    ...
    },
    {
      ...
      category: "chairs",
      description:
        "A generous wooden bench for gardens and entryways — simple, durable, and welcoming.",
      imageUrl:
    ...
    },
    {
      ...
      category: "doors",
      description:
        "Hardwood door with subtle carving — a statement entry that showcases skilled woodwork.",
      imageUrl:
    ...
    },
    {
      ...
      category: "generic",
      description:
        "A practical office desk with drawer storage — built for focused work at home.",
      imageUrl:
    ...
    },
    {
      ...
      category: "tables",
      description:
        "Dining table with a luminous glass top and solid base — light, modern, and easy to live with.",
      imageUrl:
    ...
    },
    {
      ...
      category: "tables",
      description:
        "Low coffee table in rustic wood — the centerpiece for living-room gatherings.",
      imageUrl:
    ...
    },
    {
      ...
      category: "tables",
      description:
        "Dining table with matching benches — made for open-air meals and weekend company.",
      imageUrl:
    ...
    },
    {
      ...
      category: "tables",
      description:
        "Dining table with a strong frame profile — durable construction for daily family use.",
      imageUrl:
    ...
    },
    {
      ...
      category: "tables",
      description:
        "Compact nightstand with a sculpted form — practical bedside storage with quiet style.",
      imageUrl:
    ...
    },
    {
      ...
      category: "tables",
      description:
        "Teak dining table with garden-ready presence — rich grain and lasting strength.",
      imageUrl:
    ...
    },
    {
      ...
      category: "wardrobes",
      description:
        "Full-height armoire with generous storage — a wardrobe landmark for the bedroom.",
      imageUrl:
    ...
    },
    {
      ...
      category: "wardrobes",
      description:
        "Wardrobe with chest-of-drawers character — organized storage in warm hardwood.",
      imageUrl:
    ...
    },
    {
      ...
      category: "wardrobes",
      description:
        "Sliding-door wardrobe with mirrored accents — space-smart storage for modern rooms.",
      imageUrl:
    ...
    },
    {
      ...
      category: "wardrobes",
      description:
        "Tall cupboard closet with clean paneling — versatile storage for clothing or linens.",
      imageUrl:
    ...
    },
    {
      ...
      category: "wardrobes",
      description:
        "Built-in feel cabinetry wardrobe — precise panels and practical compartment layout.",
      imageUrl:
